...
msg="$(code-review-graph status --repo "/Users/xuguoqiang/SynologyDrive/Backup/MI_office_notebook/D/myworkspace/xgq_workspace/program/src/xgq.com/dhp" 2>&1 | head -n 1 || true)"
